...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{accordionState: rundis$elm_bootstrap$Bootstrap$Accordion$initialState, classes: _List_Nil, disciplines: _List_Nil, dropdownState: rundis$elm_bootstrap$Bootstrap$Dropdown$initialState, filter: 'Computer Science', loadingValue: 10, response: author$project$Model$Loading, search: '', term: '', termSearch: 'latest', terms: _List_Nil},
		...
		switch (msg.$) {
			...
			case 'Filter':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{accordionState: rundis$elm_bootstrap$Bootstrap$Accordion$initialState, filter: str}),
...
var author$project$Model$Filter = function (a) {
	return {$: 'Filter', a: a};
};
...
var rundis$elm_bootstrap$Bootstrap$Utilities$Border$topNone = elm$html$Html$Attributes$class('border-top-0');
var rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$pt1 = elm$html$Html$Attributes$class('pt-1');
var author$project$View$accordionLink = F2(
	function (model, string) {
		var disciplineText = _Utils_eq(model.filter, string) ? A2(
			elm$html$Html$b,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text(string)
				])) : (((model.filter === '') && (string === 'All')) ? A2(
			elm$html$Html$b,
			_List_Nil,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							function () {
							var value = (string === 'All') ? '' : string;
							return elm$html$Html$Events$onClick(
								author$project$Model$Filter(value));
						}(),
							A2(elm$html$Html$Attributes$style, 'cursor', 'pointer'),
							rundis$elm_bootstrap$Bootstrap$Utilities$Border$topNone,
							rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$pt1
						])),
...
var rundis$elm_bootstrap$Bootstrap$Card$light = rundis$elm_bootstrap$Bootstrap$Card$Internal$Coloring(
	rundis$elm_bootstrap$Bootstrap$Card$Internal$Roled(rundis$elm_bootstrap$Bootstrap$Internal$Role$Light));
...
var rundis$elm_bootstrap$Bootstrap$Card$Internal$TextColoring = function (a) {
	return {$: 'TextColoring', a: a};
};
var rundis$elm_bootstrap$Bootstrap$Card$textColor = function (color) {
	return rundis$elm_bootstrap$Bootstrap$Card$Internal$TextColoring(color);
};
...
var author$project$View$viewAccordion = function (model) {
	return A2(
					...
					rundis$elm_bootstrap$Bootstrap$Accordion$card(
					{
						blocks: _List_fromArray(
							[
								...
								A2(
									elm$core$List$cons,
									A2(author$project$View$accordionLink, model, 'All'),
									A2(
										elm$core$List$map,
										author$project$View$accordionLink(model),
										model.disciplines)))
							]),
						header: A2(
						...
						options: _List_fromArray(
							[
								rundis$elm_bootstrap$Bootstrap$Card$light,
								rundis$elm_bootstrap$Bootstrap$Card$outlineLight,
								rundis$elm_bootstrap$Bootstrap$Card$textColor(rundis$elm_bootstrap$Bootstrap$Text$secondary),
								rundis$elm_bootstrap$Bootstrap$Card$attrs(
								_List_fromArray(
									[rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$mb4])),
								rundis$elm_bootstrap$Bootstrap$Card$align(rundis$elm_bootstrap$Bootstrap$Text$alignXsLeft)
							])
					})
				]),
	...
	return rundis$elm_bootstrap$Bootstrap$Table$table(
		{
			...
			tbody: A2(
				...
				A2(
					...
					A2(
						elm$core$List$filter,
						A2(author$project$View$filterCourse, model.search, model.filter),
						model.classes))),
			thead: A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					elm$html$Html$Events$onClick(
					author$project$Model$Filter(string)),
					A2(elm$html$Html$Attributes$style, 'cursor', 'pointer')
				]),
			_List_fromArray(
				[disciplineText]));
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$class('bd-accordion')
											]))
									]),
								_List_fromArray(
									[
										A2(elm$html$Html$Lazy$lazy, author$project$View$viewAccordion, model)
									])),
								A2(
								rundis$elm_bootstrap$Bootstrap$Grid$col,
								_List_fromArray(
